...
directives.directive('wizard', ['$parse', function($parse) {
  return {
    ...
    transclude: true,
    template: '<ul ng-show="active" class="wizard_steps" ng-class="activeClass()"><li class="wizard_step" ng-repeat="step in steps" ng-class="getClassForStep(step)">{{ step.label }}</li></ul> <div ng-transclude></div>',
    link: function(scope, element, attrs, ctrl) {
      ...
      var active = $parse(attrs.active)(scope);
